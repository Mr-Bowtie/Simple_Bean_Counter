...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_36
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_37
end
...
class Nokogiri::HTML4::EntityDescription < Anonymous_Struct_38
end

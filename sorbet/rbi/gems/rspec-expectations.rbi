...
class InvalidName___Class_0x00___Differ_48
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_49
end
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_50
end
